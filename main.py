...
if __name__ == '__main__':
    ...
    while True:
        ...
        if Wireguard.up and Wireguard.active_server is not None:  # Check if active server is the highest priority one
            if Wireguard.active_server == highest_score_host:
                healthy_double_checks_counter = 0
